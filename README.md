...
Collects user information from keyboard input:
...
"R" → reset game (return to Phase 1)
...
Percentage (relative to global max score)
...
**Usage:**
´´´bash
rosservice call /user_score "username: 'paula'"
´´´ 
Returns:
´´´ini
